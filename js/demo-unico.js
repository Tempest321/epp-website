...
function displayResults(result) {
    ...
    // Duration estimates (surveys use days, not months)
    document.getElementById('duration-estimate').textContent = result.duration.p50 + ' days';
    document.getElementById('duration-p10').textContent = result.duration.p10 + ' days';
    document.getElementById('duration-p50').textContent = result.duration.p50 + ' days';
    document.getElementById('duration-p90').textContent = result.duration.p90 + ' days';
